...
def do_ensemble_method_and_plot_test_accuracies(x_train, y_train, x_test, y_test,num_of_output_classes, n_epochs):
    ...
    plot_test_acc("experiments_results/ensemble_models_test_acc","Test accuracies for each number of saved_models used", scores)
    plot_sensitivity_analysis_on_number_of_ensemble_members(n_members, scores, "experiments_results/scores_for_different_ensemble_nums")