...
def evaluate_same_model_many_times():
    ...
    plot_hist_and_distribution("experiments_results_graphs/hist_of_test_acc_scores_for_one_model",
                               "experiments_results_graphs/box_and_whisker_of_test_acc_scores_for_one_model", scores)
