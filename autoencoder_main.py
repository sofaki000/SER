...
def run_model_with_autoencoder_and_without():
    ...
    model_with_autoencoder = get_model(num_of_output_classes=output_classes, input_dim=n_inputs,  lr=autoencoder_config.learning_rate)
...
run_model_with_autoencoder_and_without()